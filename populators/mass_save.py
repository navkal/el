...
if __name__ == '__main__':
    ...
    os.system( 'python mass_save_refine.py -i RawGeographicReport -o GeographicReport -r zip_code -n {0} -d ../db/{1}'.format( numeric_columns, args.output_filename ) )

    # Create table of towns
    print( '\n=======> Towns' )
    os.system( 'python mass_save_towns.py -d ../db/{0}'.format( args.output_filename ) )
