...
HEATING_FUEL_DESC = HEATING_FUEL + _DESC
...
_NWX = '_nwx'
ELEC_OIL_PARCELS_NWX = ELEC_OIL_PARCELS + _NWX
ELEC_OIL_OCCUPANCY_NWX = ELEC_OIL_OCCUPANCY + _NWX
...
CONSISTENT_COLUMN_NAMES = \
{
    ...
    'RawCommercial_1': \
    {
        ...
        'Usrfld 207 Desc': HEATING_FUEL_DESC,
        'Heating Type': HEATING_TYPE,
        'Usrfld 208 Desc': HEATING_TYPE_DESC,
        'AC Type': AC_TYPE,
        'Usrfld 209 Desc': AC_TYPE_DESC,
    ...
    {
        'Block Group Identification Number': CENSUS_GEO_ID,
        'Active Electric Locations, 2019': 'electric_locations_2019',
        'Active Electric Accounts as of December, 2019': 'electric_accounts_2019',
        '2013 Electric Location Participation Rate': 'electric_participation_2013',
        '2014 Electric Location Participation Rate': 'electric_participation_2014',
        '2015 Electric Location Participation Rate': 'electric_participation_2015',
        '2016 Electric Location Participation Rate': 'electric_participation_2016',
        '2017 Electric Location Participation Rate': 'electric_participation_2017',
        '2018 Electric Location Participation Rate': 'electric_participation_2018',
        '2019 Electric Location Participation Rate': 'electric_participation_2019',
        '2013-2019 Total Electric Location Participation Rate': 'electric_participation_all_years',
        'Active Gas Locations, 2019': 'gas_locations_2019',
        'Active Gas Accounts as of December, 2019': 'gas_accounts_2019',
        '2013 Gas Location Participation Rate': 'gas_participation_2013',
        '2014 Gas Location Participation Rate': 'gas_participation_2014',
        '2015 Gas Location Participation Rate': 'gas_participation_2015',
        '2016 Gas Location Participation Rate': 'gas_participation_2016',
        '2017 Gas Location Participation Rate': 'gas_participation_2017',
        '2018 Gas Location Participation Rate': 'gas_participation_2018',
        '2019 Gas Location Participation Rate': 'gas_participation_2019',
        '2013-2019 Total Gas Location Participation Rate': 'gas_participation_all_years',
    },
    ...
    'RawResidential_1': \
    {
        ...
        'CNS_HEAT_TYPE_DESC': HEATING_TYPE_DESC,
        'CNS_AC_TYPE': AC_TYPE,
        'CNS_AC_TYPE_DESC': AC_TYPE_DESC,
    ...
    'RawResidential_4': \
    {
        ...
        'Heat Type Desc': HEATING_TYPE_DESC,
        'AC Type:': AC_TYPE,
...
COLUMN_ORDER = \
{
    ...
    [
        ...
        * COLUMN_GROUP['WARD_SUMMARY_ZIP'],
        ...
        ROOF_PERMIT + _COUNT + with_units( '2_4' ),
        ROOF_PERMIT + _COUNT + with_units( 2 ),
        ROOF_PERMIT + _COUNT + with_units( 3 ),
        ROOF_PERMIT + _COUNT + with_units( 4 ),
    ],
    ...
    [
        ...
        * COLUMN_GROUP['WARD_SUMMARY_ZIP'],
        ...
        ROOF_PERMIT + _COUNT + with_units( 4, gt=True ),
        ROOF_PERMIT + _COUNT + with_units( 5 ),
        ROOF_PERMIT + _COUNT + with_units( 6 ),
        ROOF_PERMIT + _COUNT + with_units( 7 ),
        ROOF_PERMIT + _COUNT + with_units( 8, plus=True ),
    ],
    'Water':
    [
        SERVICE_ID,
